...
Tile.prototype.genId = function(){
    Tile.prototype.unique_id_gen = Tile.prototype.unique_id_gen || 0;
    Tile.prototype.unique_id_gen++;
    return Tile.prototype.unique_id_gen;
};

Tile.prototype.getSlotAbsoluteXY = function(slot){
...
Tile.prototype.addThing = function(thing,pos){
    this.things[pos] = thing;
};

Tile.prototype.removeThing = function(pos){
...
Tile.prototype.draw = function(){
    ...
    this.model.slots.each(function(slotModel,index){
        if(slotModel && slotModel.stand){
            this.things.push(new client.engine.Thing({tile: this, slot: index, model:  new client.models.ThingModel(slotModel.stand), game: this.game, image:"zombie", goback: true, noupdate: true}));
        }
    },this);
